...
def process_cmd_opts():
    ...
    def interpret_help(args) -> None:
        if args.help:
            if len(sys.argv) - 1 < 2:
                ...
                print("    -a, --anchor TRUST_ANCHOR         |   trust anchor file (base64). Example: \"hydra.ndncert\"")
    ...
    def create_config():
        ...
        config_data = {
            ...
            "trust_anchor_path": default_config_file['default_config']['security']['trust_anchor_path'],
            "lvs_model_path": default_config_file['default_config']['security']['lvs_model_path'],
            "box_sqlite3_path": default_config_file['default_config']['security']['box_sqlite3_path'],
            "tpm_path": default_config_file['default_config']['security']['tpm_path'],
        }
...
class HydraNodeThread(Thread):
    ...
    def run(self) -> None:
        ...
        asyncio.run(prepare_keys(self.config['repo_prefix'], self.config['node_name'], app, self.config))
